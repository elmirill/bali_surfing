...
#  end
  ...
  def create
    ...
    respond_to do |format|
      if @accommodation.save
        format.html { redirect_to accommodations_path, notice: 'Accommodation was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @accommodation.update(accommodation_params)
        format.html { redirect_to accommodations_path, notice: 'Accommodation was successfully updated.' }
  ...
  private
    ...
    def accommodation_params
      params.require(:accommodation).permit(:title, :subtitle, :content, :price_1, :price_2, :price_3, :position, :thumbnail, :_destroy)
    end
end
